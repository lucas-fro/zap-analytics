...
function GraficosGroupBase({ data }: { data: AnalyzeAllResult }) {
  return (
    <section className="flex flex-col gap-4 md:gap-5 mt-6 md:mt-10 mb-10 px-5 md:px-10 w-full max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
        <GraficMsgnMes data={data.graficos.mensagensPorMes} className="md:col-span-2" />
        <GraficPorDiaDaSemana data={data.graficos.mensagensPorDiaSemanaPorPessoa} />
        <GraficAtividadePorHora data={data.graficos.mensagensPorHoraPorPessoa} />
        <GraficMensagensPorPessoaPorMes data={data.graficos.mensagensPorPessoaPorMes} />
...
export const GraficosGroup = memo(GraficosGroupBase);
